...
class Editor extends Component {
  ...
  constructor() {
    ...
    let selectedIndex = 0;
    if (window.location.pathname.startsWith(`${this.props.match.url}/story`)) { selectedIndex = 1; }
    if (window.location.pathname.startsWith(`${this.props.match.url}/design`)) { selectedIndex = 2; }
    if (window.location.pathname.startsWith(`${this.props.match.url}/play`)) { selectedIndex = 3; }
